Tous les fichiers .java se situent dans le dossier src. Tous les fichiers .class se situent dans le dossier bin.La classe main de ce programme est la classe Mastermind héritée d'une JFrame.Le dossier JAR permet de lancer directement le jeu.
...
Combinaison.java		Paramétrisation des tentatives du joueurs
FenetreFin.java			Message de fin pour le joueur
ModeOrdinateur.java		Paramétrisation du mode ordinateur
